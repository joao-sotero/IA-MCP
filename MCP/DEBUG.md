...
O debug é essencial para:
- ✅ Entender o fluxo de execução
- ✅ Ver valores de variáveis em tempo real
- ✅ Identificar erros
- ✅ Aprender como a IA toma decisões

**Pratique!** Use o debugger para acompanhar todo o fluxo MCP.
